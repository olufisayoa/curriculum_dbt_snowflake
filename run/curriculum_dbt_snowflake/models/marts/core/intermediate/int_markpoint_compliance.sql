...
SELECT 
       ...
       md5(cast(coalesce(cast(OfferingID as TEXT), '_dbt_utils_surrogate_key_null_') || '-' || coalesce(cast(OfferingGroupID as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) AS CourseKey,
